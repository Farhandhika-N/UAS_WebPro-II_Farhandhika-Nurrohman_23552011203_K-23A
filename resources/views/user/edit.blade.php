...
<div class="page-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    <div>
        ...
        <p class="mb-0">Perbarui data profil pengguna dan sesuaikan hak akses sistem jika diperlukan</p>
    </div>
...
<div class="card-form shadow-lg mb-5">
    ...
    <form action="{{ route('user.update', $user) }}" method="POST">
        ...
        {{-- VALIDASI ROLE SENDIRI / ORANG LAIN --}}
        @if(auth()->id() != $user->id)
            <div class="row">
                {{-- ROLE --}}
                <div class="col-md-6 mb-4">
        ...
        @else
            {{-- ALERT WARNING UNTUK AKUN SENDIRI --}}
            <div class="alert alert-warning border-0 mb-4" style="border-radius: 12px; background-color: rgba(245, 158, 11, 0.15) !important; color: #fbbf24 !important;">
                <div class="d-flex gap-2 align-items-center">
                    <i class="bi bi-exclamation-circle-fill"></i>
                    <div>
                        Anda sedang mengedit akun sendiri. Perubahan <strong>Role / Hak Akses</strong> tidak diperbolehkan.
                    </div>
                </div>
            </div>
        @endif
